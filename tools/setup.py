...
def main():
    ...
    print("""
  ######################################
  # hct_164 Development Environment Setup #
  ######################################

  This script will create your hct_164 dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your hct_164 project folder:
    [Arma 3 installation directory]\\{} => hct_164 project folder
    P:\\{}                              => hct_164 project folder
